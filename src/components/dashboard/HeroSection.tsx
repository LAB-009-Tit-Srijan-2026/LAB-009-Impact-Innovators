...
import { Sparkles, TrendingUp, Globe, Star, MapPin } from 'lucide-react';
    ...
    <div className="relative overflow-hidden rounded-3xl mb-6" style={{
      ...
      <div className="relative z-10 p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        <div className="flex-1">
          ...
          >
            <button className="bg-white text-purple-700 font-semibold px-5 py-2.5 rounded-xl hover:bg-purple-50 transition-colors shadow-lg text-sm">
              🚀 Trip Plan Karo
            </button>
            <button className="bg-white/20 backdrop-blur-sm text-white font-medium px-5 py-2.5 rounded-xl hover:bg-white/30 transition-colors text-sm border border-white/30">
